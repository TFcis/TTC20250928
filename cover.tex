...
\begin{center}
\textbf{\huge Toj Theme Contest 004 數論入門}\\
\vspace{5mm}
\textbf{\huge Toj Theme Contest 004 數論入門\ 試題本}\\
\vspace{10mm}
\rule{17cm}{2pt}\\
\vspace{5mm}
...
\begin{enumerate}
    ...
    \item 競賽時間：2025/9/27 13:00 \textasciitilde \, 16:00，共 3 小時。
    ...
    \item 如有電腦問題，請自行換一台新的。
    \item 如有如廁需求，請自行去炸廁所
    \item 不得使用 ChatGPT 否則會被 reject 掉。
